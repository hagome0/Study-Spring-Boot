...
import com.community.domin.Book;
...
public class BookJsonTest {
    ...
    public void json_테스트() throws Exception {
        ...
        String cotent = "{\"title\":\"테스트\"}";

        assertThat(this.json.parseObject(cotent).getTitle()).isEqualTo(book.getTitle());
        assertThat(this.json.parseObject(cotent).getPublishedAt()).isNull();
